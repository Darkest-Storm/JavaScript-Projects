...
function Input_Decimal(dot){
    //This ensures that accidental clicking decimal point doesn't 
...
function Handle_Operator(Next_Operator){
    ...
    //displayed on the screen to a number and store the result in
    //Calculator.First_Operand if it doesnt exist yet.
    const Value_of_Input = parseFloat(Display_Value);
    //Checks if an operator already exits and if Wait_Second_Operand is true,
...
keys.addEventListener('click', (event) => {
    ...
    //Ensures that AC clears all inputs from calc screen
